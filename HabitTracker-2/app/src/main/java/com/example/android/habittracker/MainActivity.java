...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayDatabaseInfo(Cursor cursor) {
        ...
        try {
            ...
            int frequencyColumnIndex = cursor.getColumnIndex(HabitContract.HabitEntry.COLUMN_FREQUENCY);
    ...
    private void insertHabit() {
        ...
        values.put(HabitContract.HabitEntry.COLUMN_NAME, "Yoga");
        values.put(HabitContract.HabitEntry.COLUMN_DURATION, 60);
        values.put(HabitContract.HabitEntry.COLUMN_FREQUENCY, HabitContract.HabitEntry.FREQUENCY_DAILY);
